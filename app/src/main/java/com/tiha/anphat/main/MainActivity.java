...
//        presenter.GetListAllCart(PublicVariables.UserInfo.getNguoiDungMobileID());
    ...
    protected void initView() {
        ...
        binding.layoutLogout.setOnClickListener(view1 -> alertDialog(
                "ĐĂNG XUẤT", "Bạn có chắc muốn đăng xuất ứng dụng?",
