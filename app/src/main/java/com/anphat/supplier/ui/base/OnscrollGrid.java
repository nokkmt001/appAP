...
public abstract class OnscrollGrid extends RecyclerView.OnScrollListener{
    public static String TAG = OnscrollGrid.class.getSimpleName();
    ...
    public OnscrollGrid(LinearLayoutManager linearLayoutManager) {
        this.mLayoutManager = linearLayoutManager;
        isUseLinearLayoutManager = true;
    }

    public OnscrollGrid(GridLayoutManager gridLayoutManager) {
