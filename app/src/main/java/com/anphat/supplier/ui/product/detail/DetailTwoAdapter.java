...
public class DetailTwoAdapter extends RecyclerView.Adapter<DetailTwoAdapter.MyViewHolder> implements Filterable {
    ...
    public DetailTwoAdapter(Context context, List<ProductNew> list, String category) {
