...
public class ProductViewModel extends BaseViewModel {
    ...
    public void getListAllProduct(Integer begin, Integer end) {
        server.GetListProductNewAP(begin, end).subscribeOn(Schedulers.io())
    ...
    public void getListProductPromotion() {
        server.GetListProductPromotion().subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<ApiResponse<ProductNew>>() {
                    @Override
                    public void onSubscribe(Disposable d) {
    ...
    public void getBanner() {
        server.GetListBannerAP("api/slider").subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
...
//        server.GetListBannerAP("api/banner").subscribeOn(Schedulers.io())
//                .observeOn(AndroidSchedulers.mainThread())
//                .subscribe(new Observer<ApiResponse<BannerInfo>>() {
//                    @Override
//                    public void onSubscribe(Disposable d) {
...
//                });
    ...
    public void GetProduct(String ID) {
        server.GetProductAP(ID).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    public void getListAllCategory() {
        server.GetCategoryNewAP().subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
